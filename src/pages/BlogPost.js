...
const BlogPost = () => {
    ...
    return (_jsx(motion.main, { initial: { opacity: 0, y: 50 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5 }, className: "bg-gray-900 text-neonGreen px-4 py-8", children: _jsxs("section", { className: "max-w-5xl mx-auto", children: [_jsx(Link, { to: "/blog", className: "text-gray-400 hover:text-neonGreen underline mb-4 block", children: "\u2190 Back to Blog" }), _jsx("h1", { className: "text-4xl font-bold mb-2", children: post.title }), _jsxs("p", { className: "text-sm text-gray-400 mb-6", children: [post.date, " \u2022 ", post.readTime, " \u2022 ", post.author] }), _jsx("article", { className: "prose prose-lg prose-invert", children: _jsx(ReactMarkdown, { remarkPlugins: [remarkGfm], children: post.content }) }), _jsx("div", { className: "mt-8", children: post.tags.map((tag) => (_jsxs("span", { className: "bg-gray-700 text-neonGreen px-3 py-1 rounded-full text-sm mr-2", children: ["#", tag] }, tag))) })] }) }));
};
